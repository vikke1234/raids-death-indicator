...
import com.raidsdeathindicator.enemydata.scabaras.Kephri;
import com.raidsdeathindicator.enemydata.scabaras.Kephri721;
import com.raidsdeathindicator.enemydata.scabaras.Spitter;
import com.raidsdeathindicator.enemydata.scabaras.Swarm;
...
public class ScalingTests {
    ...
    public void akkhaScalingTest() {
        ...
        assertEquals(1.575, akkha.getModifier(), delta);
        TestNPC swarmNpc = new TestNPC(NpcID.SCARAB_SWARM_11723);
        Enemy swarm = new Swarm(swarmNpc, 305, 2, 0);
